...
7. Impacket (incl. Secretsdump, SMBrelayx & WMIexec) - Python offensive security framework </br> (https://github.com/SecureAuthCorp/impacket)
...
13. PowerSharpPack - Many usefull offensive CSharp Projects wraped into Powershell for easy usage </br> (https://github.com/S3cur3Th1sSh1t/PowerSharpPack)
...
18. Nimcrypt2 - .NET, PE and raw shellcode packer/loader designed to bypass AV/EDR </br> (https://github.com/icyguider/Nimcrypt2)
19. Metasploit penetration testing framework </br> (https://www.metasploit.com)
20. Sliver - Open source cross-platform adversary emulation/red team framework </br> (https://github.com/BishopFox/sliver)
21. LAPSToolkit - LAPS auditing for pentesters </br> (https://github.com/leoloobeek/LAPSToolkit)
22. PrivescCheck.ps1 - This script aims to enumerate common Windows configuration issues that can be leveraged for local privilege escalation </br>  (https://github.com/itm4n/PrivescCheck)
23.  Seatbelt - C# project that performs a number of security oriented host-survey "safety checks" relevant from both offensive & defensive security perspectives </br> (https://github.com/GhostPack/Seatbelt)
24. Juicy potato exploit </br> (https://github.com/ohpe/juicy-potato)
25. Rotten potato exploit </br> (https://github.com/breenmachine/RottenPotatoNG)
26. Hydra - Online password bruteforce tool </br> (https://github.com/vanhauser-thc/thc-hydra)
27. John the Ripper - Offline password cracker </br> (https://www.openwall.com/john/)
28. Hashcat - Offline password cracker </br> (https://hashcat.net/hashcat/)
29. Enum4linux - Tool for enumerating information from Windows and Samba systems </br> (https://tools.kali.org/information-gathering/enum4linux)
30. Vulnerability scanners (e.g. OpenVAS, Nessus, Qualys, Nexpose, ...) </br> (https://github.com/greenbone/openvas-scanner/releases) (https://www.tenable.com/) (https://www.qualys.com/) (https://www.rapid7.com/products/nexpose/)
31. NMAP - Network port scanner and (NSE) scripts </br> (https://nmap.org)
32. Various KALI tools & scripts </br> (https://www.kali.org/tools/all-tools/)
33. Various tools & scripts (source:Github/your owns)
